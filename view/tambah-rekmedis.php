              ...
              <div class="table-responsive">
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  <tbody>
                    ...
                    ?>
                    <tr>
                      <td id='kddaftar_<?php echo $tampil['kddaftar'];?>'><?php echo $tampil['kddaftar']; ?></td>
                      <td align="center" id='nmpasien_<?php echo $tampil['kddaftar'];?>'><?php echo $tampil['nmpasien']; ?></td>
                      <td align="center" id='umur_<?php echo $tampil['kddaftar'];?>'><?php echo $tampil['umur']; ?></td>
                      <td id='keluhan_<?php echo $tampil['kddaftar'];?>'><?php echo $tampil['keluhan']; ?></td>
                      <td align="center"><button onclick="pilihDaftar('<?php echo $tampil['kddaftar']; ?>')" class="btn btn-info btn-xs">Pilih</button></td>
                    </tr>
                    <?php } ?>
