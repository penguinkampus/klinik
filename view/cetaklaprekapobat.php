...
<table width="100%" border="1" cellspacing="0">
  <tr>
    ...
    <td align="center"><b>Jumlah Keluar</b></td>
  </tr>
  <tr>
    <?php
    $no = 1;
    ...
    $get = mysql_query("
          SELECT *,(SELECT COUNT(nmobat) from trmedis x JOIN detail_obat xb ON x.nomedis = xb.nomedis where x.nomedis = a.nomedis) jumlah FROM trmedis a 
JOIN detail_obat b ON a.nomedis = b.nomedis
     WHERE a.tglmedis <= '$date1'
     GROUP by b.nmobat
     ");
