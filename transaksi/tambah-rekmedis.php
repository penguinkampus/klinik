...
?>
    ...
    <head>
        ...
        <title>Tambah Rekam Medis - Klinik</title>
        <!-- Bootstrap Core CSS -->
  ...
  <![endif]-->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php include 'header.php'; ?>
                ...
                <?php include 'nav.php'; ?>
                    ...
                    <?php include '../view/tambah-rekmedis.php'; ?>
        ...
        <script>
            ...
            $(document).ready(function() {
                $('#dataTables-dokter').DataTable({
                    responsive: true
                });
            });

            $(document).ready(function() {
                $('#dataTables-tindakan').DataTable({
                    responsive: true
                });
            });

            $(document).ready(function() {
                $('#dataTables-obat').DataTable({
                    responsive: true
                });
            });
        </script>
